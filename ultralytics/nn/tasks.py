...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            C3Ghost, nn.Conv2d, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3, PSA, SCDown, C2fCIB, FeaturePyramidSharedConv,
            CSP_MSCB
        }:
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            ...
            args = [c1, c2, *args[1:]]
            if m in {
                     BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB, CSP_MSCB
                     }:
        ...
        elif m in {SpatialAttention, EUCB}:
            c2 = ch[f]
            args = [c2, *args]
            # print(args)
